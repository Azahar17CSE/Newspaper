      ...
      if (isset($_GET['p_id'])) 
          {
              $single_id = $_GET['p_id'];
                ...
                $query = "SELECT * FROM post WHERE post_id ='$single_id'";
                            ...
                            <div class="page-wrapper">
                                <div class="blog-title-area">
                                    ...
                                    <div class="blog-meta big-meta">
                                        <small><a href="marketing-single.html" title=""><?php echo "$post_date"; ?></a></small>
                                ...
                                <div class="custombox authorbox clearfix">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                            <img src="admin/img/users/<?php echo "$post_thumbnail"; ?>" alt="" class="img-fluid rounded-circle"> 
                                        </div><!-- end col -->
